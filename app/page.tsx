                  ...
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <div className="flex flex-col gap-1.5 flex-shrink-0">
                      {rec.tags.map((tag: string, tagIdx: number) => (
                        <span 
                          key={tagIdx} 
                          className={`text-[9px] font-bold uppercase ${tag === "Cost" ? "bg-rose-50 text-rose-700 border border-rose-100" : tag === "Efficiency" ? "bg-amber-50 text-amber-700 border border-amber-100" : "bg-emerald-50 text-emerald-700 border border-emerald-100"}`}>
                          {tag}
                        </span>
                      ))}
                    </div>
